...
function DiamondNode({ data }: { data: any }) {
  ...
  return (
    <div
      className="relative bg-white border-2 border-gray-300 p-4 flex items-center justify-center transform rotate-45 cursor-pointer group"
    ...
    >
      ...
      {isEditing ? (
        ...
        <span className="text-center w-full transform -rotate-45">{label || '双击编辑'}</span>
      )}
    </div>
  )
}
